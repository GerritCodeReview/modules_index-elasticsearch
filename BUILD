...
junit_tests(
    name = "elasticsearch_query_account",
    srcs = glob(["src/test/java/**/ElasticV7QueryAccountsTest.java"]),
    tags = ELASTICSEARCH_TAGS,
    deps = ELASTICSEARCH_DEPS + HTTP_TEST_DEPS + [
        ACCOUNT_QUERY_TESTS_DEP,
...
junit_tests(
    ...
    deps = PLUGIN_TEST_DEPS + [
        ":index-elasticsearch__plugin",
        "//javatests/com/google/gerrit/server/query/%s:abstract_query_tests",
    ],
)
